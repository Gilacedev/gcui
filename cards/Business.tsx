  ...
  return (
    <Blocks.Dark className={"p-4 rounded-2xl"}>
      ...
      <div className={"absolute top-3 left-3 "}>
        ...
        {business._status === 2 && <span className={"text-slate-400 text-4xl fa-sharp fa fa-cog fa-spin"}></span>}
        {business._status === 3 && (
          <span>
      ...
      <div className={"flex flex-col gap-4 relative z-[3]"}>
        ...
        {editable && (
          <div className={"flex justify-between w-full gap-2"}>
            <Button className={"flex"} color={ColorTypes.primary} tag={"a"} href={`/management/business/${business.id}`}>
