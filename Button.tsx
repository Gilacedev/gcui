...
interface ComponentProps extends HTMLAttributes<HTMLOrSVGElement> {
  ...
  type?: string;
  loading?: number;
  disabled?: boolean;  // Explicitly add disabled here
}
...
const Button: React.FC<ComponentProps> = ({
  ...
  // If href is provided and it's a valid string, render as a link
  ...
  // If href is not provided or button is disabled, render as a button
  return (
    <Tag
      {...props}
      className={className}
