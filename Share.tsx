...
const Share: React.FC<ShareProps> = ({ animation, text }) => {
	...
	return (
	  <div
		...
		className={`flex cursor-pointer items-center justify-center bg-bg-gilace/50 relative w-12 h-12 md:w-16 md:h-16 ${animation && "animate-(--animate-on-the-earth)"} rounded-xl text-slate-50`}
	  >
